...
public class MenuServiceImpl implements MenuService {
    ...
    public List<Map> findMenusByLoginName(String loginName){
        List<Menu> menuList = menuMapper.findMenusByLoginName(loginName);
        return findMenuListByParantId(menuList,"0");
    }
    ...
    private List<Map> findMenuListByParantId(List<Menu> menuList,String parentId){
        ...
        for (Menu menu:menuList){
            if (menu.getParentId().equals(parentId)){
                ...
                map.put("children",findMenuListByParantId(menuList,menu.getId()));
                mapList.add(map);
            }
        }
        return mapList;
